...
# 一些小巧思，另一种解体思路，不同编辑器写的，可能换行有问题，试过了，可以运行
# # 列表
# # 1. 创建一个包含1到10的列表
# numbers = [x+1 for x in range(10)]
# print(numbers)
...
# total_score = sum(courses.values())
# print(total_score/len(courses))
# # 4. 找出最高分和最低分
# print(f"最高分{max(courses.values())}")
# print(f"最低分{min(courses.values())}")
# # 5. 找出最高分的科目
# # 方法1：遍历字典
# max_subject = ""
# max_score = 0
...
# print(f"{max_subject}")
# # 方法2：使用列表推导式
# max_subject_2 = [subject for subject, score in courses.items() if score == max_score]
# print(f"{max_subject_2[0]}")
# # 6. 添加一门新科目（物理，88分）
# student.get("courses").update({"物理": 88})
# print(student)
# # 7. 删除语文科目
# student["courses"].pop("语文")
# print(student)
# # 8. 输出所有科目和成绩（格式化）
# for v, k in student["courses"].items():
#     print(f"课程：{v}, 成绩：{k}")
#
# # 字符串处理练习
# # 1. 定义一个字符串
...
# # 5. 统计字符数（不包含空格）
# print(f"原字符个数{len(s)}")
# print(f"原字符个数{len(s.strip().replace(" ", ""))}")
# # 6. 统计单词数
# s_strip = s.strip()
# words = s_strip.split()
# print(len(words))
...
# # 10. 格式化输出
# print(f"原始字符串：{s}")
# print(f"处理后字符串：{s_strip}")
# print(f"处理后长：{len(s_strip)}")
# print(f"首字母：{s_strip[0]}")
# print(f"尾字母：{s_strip[-1]}")
